...
"""
basepath = '/Users/pbmanis/Documents/data/NCAM/'
...
datasets = {'m1a': {'dir': '2017.04.25_000/slice_000/cell_001', 'prots': [0,1,3], 
            ...
            'm5b': {'dir': '2017.05.11_000/slice_000/cell_000', 'prots': [0,1,2], 
				'thr': 1.5, 'rt': 0.35, 'decay': 4., 'G': 'F/+', 'exclist': []},
           ...
           # 'm7e': {'dir': '2017.07.06_000/slice_000/cell_004', 'prots': [0,1,2], 
            ...
            'm9b': {'dir': '2017.07.19_000/slice_000/cell_001', 'prots': [1], 
				'thr': 1.75, 'rt': 0.35, 'decay': 5., 'G': 'F/+', 'exclist': []},
            'm9c': {'dir': '2017.07.19_000/slice_000/cell_002', 'prots': [0,1,2], 
				'thr': 1.5, 'rt': 0.35, 'decay': 5., 'G': 'F/+', 'exclist': []},
            # incomple data for m9d11:
            # 'm9d': {'dir': '2017.07.19_000/slice_000/cell_003', 'prots': [0], 
			#	'thr': 1.75, 'rt': 0.35, 'decay': 5., 'G': 'F/+', 'exclist': []},
            # m10a: runs 1 & 2 have unacceptable noise
            'm10a': {'dir': '2017.07.27_000/slice_000/cell_000', 'prots': [0], 
				'thr': 2.0, 'rt': 0.35, 'decay': 5., 'G': 'F/F', 'exclist': []},
            'm10b': {'dir': '2017.07.27_000/slice_000/cell_001', 'prots': [0], 
				'thr': 1.75, 'rt': 0.35, 'decay': 5., 'G': 'F/F', 'exclist': []},
            'm10c': {'dir': '2017.07.27_000/slice_000/cell_002', 'prots': [0], 
...
#
            ...
            'm13b': {'dir': '2017.08.15_000/slice_000/cell_001', 'prots': [1,2], 
				'thr': 1.0, 'rt': 0.35, 'decay': 4., 'G': 'F/+', 'exclist': []},
            'm13c': {'dir': '2017.08.15_000/slice_000/cell_002', 'prots': [1,2], 
				'thr': 3.0, 'rt': 0.35, 'decay': 4., 'G': 'F/+', 'exclist': []},  # protocol minis_000 not very good - removed
            #'m13d': {'dir': '2017.08.15_000/slice_000/cell_003', 'prots': [0,1,2], 
			#	'thr': 2.0, 'rt': 0.35, 'decay': 4., 'G': 'F/+', 'exclist': []}, # quite variable rate in runs 0 and 1 - dropped entire recording
            'm13e': {'dir': '2017.08.15_000/slice_000/cell_004', 'prots': [3], 
				'thr': 1.75, 'rt': 0.35, 'decay': 4., 'G': 'F/+', 'exclist': []},  # runs 1 and 2 had burstiness and instability - dropped
            # m13f has weird bursts - exclude
            #'m13f': {'dir': '2017.08.15_000/slice_000/cell_005', 'prots': [0,1,2], 
			#	'thr': 2.5, 'rt': 0.35, 'decay': 4., 'G': 'F/+', 'exclist': []},
            # cells 006 and 007 are no good for 8/15
            # cells 000, 001 002 ng for 8/16
            'm14d': {'dir': '2017.08.16_000/slice_000/cell_003', 'prots': [1,2], 
				'thr': 1.5, 'rt': 0.35, 'decay': 4., 'G': 'F/F', 'exclist': []},  # dropped run 0 - had unstable traces (baseline drift)
